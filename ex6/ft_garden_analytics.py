...
class FloweringPlant(Plant):
    ...
    def get_info(self):
        print(f"{self.get_name()}: {self.get_height()}cm, {self.__color} flowers{' (blooming)' if self.__is_blooming else ''}")
...
class PrizeFlower(FloweringPlant):
    ...
    def get_info(self):
        print(f"{self.name}: {self.height}cm, {self.color} flowers{' (blooming)' if self.is_blooming else ''}, Prize points: {self.prize_points}")
